...
| 21 | `rust/crates/runtime-anomaly`, `python/runtime_anomaly` | risk-signal schema/migration/config | trajectory, semantic/statistical and continuous-auth tests |
...
| 32 | `rust/crates/context-governance` | memory/prompt schemas, migration/config | authorization-before-retrieval, quarantine, expiry and rollback |
...
| 36 | `rust/crates/production-closure` | certificate schema/migration/config and release runbook | gate aggregation, real-evidence requirement, signature and revocation |
