...
CREATE TABLE public.sensitive_consent_records (
...
CREATE TABLE public.sensitive_conversation_cases (
...
CREATE TABLE public.sensitive_source_citations (
...
CREATE TABLE public.sensitive_human_escalations (
...
CREATE TABLE public.sensitive_evaluation_findings (
...
CREATE INDEX sensitive_escalation_state_idx ON public.sensitive_human_escalations(tenant_id,status,requested_at);
CREATE INDEX sensitive_consent_subject_idx ON public.sensitive_consent_records(tenant_id,subject_ref_digest,purpose,status,expires_at);
