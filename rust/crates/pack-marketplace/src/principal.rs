//! Verification of request-bound human assertions at the Pack Marketplace boundary.
...
pub enum PrincipalAssertionError {
    #[error("MARKETPLACE_PRINCIPAL_CONFIGURATION_INVALID")]
    ConfigurationInvalid,
    #[error("MARKETPLACE_PRINCIPAL_ASSERTION_INVALID")]
    AssertionInvalid,
}
